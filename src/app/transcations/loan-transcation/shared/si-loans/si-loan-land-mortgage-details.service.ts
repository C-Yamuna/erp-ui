...
export class SiLoanLandMortgageDetailsService {

  constructor(private commonHttpService: CommonHttpService) { }

  updateSILoanLandMortgageDetails(loansModel: any) {
  ...
  addSILoanLandMortgageDetails(loansModel: any) {
  ...
  getSILoanLandMortgageDetailsById(id: string) {
  ...
  getAllSILoanLandMortgageDetails(){
  ...
  deleteSILoanLandMortgageDetails(id: string) {
    let headers = new HttpHeaders({ 'id': id + '' })
