...
export class TermLoanLandMortgageDetailsService {

  constructor(private commonHttpService: CommonHttpService) { }

  updateTermLoanLandMortgageDetails(loansModel: any) {
  ...
  addTermLoanLandMortgageDetails(loansModel: any) {
  ...
  getTermLoanLandMortgageDetailsById(id: string) {
  ...
  getAllTermLoanLandMortgageDetails(){
  ...
  deleteTermLoanLandMortgageDetails(id: string) {
    let headers = new HttpHeaders({ 'id': id + '' })
