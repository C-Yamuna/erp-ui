...
export class TermLoanVehicleMortgageDetailsService {

  constructor(private commonHttpService: CommonHttpService) { }

  updateTermLoanVehicleMortgageDetails(loansModel: any) {
  ...
  addTermLoanVehicleMortgageDetails(loansModel: any) {
  ...
  getTermLoanVehicleMortgageDetailsById(id: string) {
  ...
  getAllTermLoanVehicleMortgageDetails(){
  ...
  deleteTermLoanVehicleMortgageDetails(id: string) {
    let headers = new HttpHeaders({ 'id': id + '' })
