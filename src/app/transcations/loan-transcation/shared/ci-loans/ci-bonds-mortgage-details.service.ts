...
export class CiBondsMortgageDetailsService {

  constructor(private commonHttpService: CommonHttpService) { }

  updateCiBondsMortgageDetails(loansModel: any) {
  ...
  addCiBondsMortgageDetails(loansModel: any) {
  ...
  getCiBondsMortgageDetailsById(id: string) {
  ...
  deleteCiBondsMortgageDetails(id: string) {
    let headers = new HttpHeaders({ 'id': id + '' })
