...
export class CiLoanGoldMortgageDetailsService {

  constructor(private commonHttpService: CommonHttpService) { }

  updateCiLoanGoldMortgageDetails(loansModel: any) {
  ...
  addCiLoanGoldMortgageDetails(loansModel: any) {
  ...
  getCiLoanGoldMortgageDetailsById(id: string) {
  ...
  getAllCiLoanGoldMortgageDetails(){
  ...
  deleteCiLoanGoldMortgageDetails(id: string) {
    let headers = new HttpHeaders({ 'id': id + '' })
