...
export class SaoNomineeComponent {
    ...
    if (flag) {
      ...
      if (this.saoNomineeModel != null && this.saoNomineeModel != undefined) {
        ...
        if (this.saoNomineeModel.nomineeFilePath != null && this.saoNomineeModel.nomineeFilePath != undefined) {
          nomineeFilePath = this.saoNomineeModel.nomineeFilePath;
      ...
      if (nomineeFilePath != null && nomineeFilePath != undefined) {
        this.saoNomineeModel.nomineeFilePath = nomineeFilePath;
      }
    }
  ...
  nomineeValidatorsRequired() {
    ...
    this.nomineeForm.get('nomineeFilePath')?.enable();
    ...
    const controlSix = this.nomineeForm.get('nomineeEmailId');
    if (controlSix) {
      controlSix.setValidators([
  ...
  nomineeFormValidation() {
    ...
    this.nomineeForm.get('nomineeFilePath')?.disable();
    const controlName = this.nomineeForm.get('relationTypeName');
    if (controlName) {
      ...
      if (this.responseModel != null && this.responseModel != undefined) {
        if (this.responseModel.status == applicationConstants.STATUS_SUCCESS) {
          if (this.responseModel.data[0] != null && this.responseModel.data[0] != undefined) {
            ...
            //   }
            // }
            if (this.saoNomineeModel.nomineeType != 0) {
              this.onChange(this.saoNomineeModel.nomineeType, this.flag);
            }
            if (this.saoNomineeModel != null && this.saoNomineeModel != undefined) {
              if (this.saoNomineeModel.nomineeFilePath != null && this.saoNomineeModel.nomineeFilePath != undefined) {
