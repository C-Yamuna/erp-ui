...
@Component({
  selector: 'app-sao-required-documents-config',
  templateUrl: './sao-required-documents-config.component.html',
  styleUrls: ['./sao-required-documents-config.component.css']
})
export class SaoRequiredDocumentsConfigComponent {
   ...
   */
    ...
    this.saoProductDefinitionsService.getPreviewDetailsByProductId(id).subscribe(res => {
      ...
      if (this.responseModel.status == applicationConstants.STATUS_SUCCESS && this.responseModel.data[0] != null) {
        ...
        if (this.saoProductDefinitionModel.saoRequiredDocumentsConfigDTOList != null && this.saoProductDefinitionModel.saoRequiredDocumentsConfigDTOList != undefined &&
            this.saoProductDefinitionModel.saoRequiredDocumentsConfigDTOList.length > 0) {
