...
export class FdNonCumulativeCommunicationService {
  ...
  updateCommunication(fdNonCummCommunicationDto:any){
    return this.commonHttpService.put(fdNonCummCommunicationDto, Headers, ERP_TRANSACTION_CONSTANTS.TERMDEPOSITS + ERP_TRANSACTION_CONSTANTS.FD_NON_CUMM_COMMUNICATION_DETAILS + ERP_TRANSACTION_CONSTANTS.UPDATE);
  }
