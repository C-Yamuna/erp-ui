  ...
  productNameDuplicateCheck() {
    ...
    if (this.isEdit) {
      if (null != this.tempProductDefinitionList && undefined != this.tempProductDefinitionList && this.tempProductDefinitionList.length > 0) {
        const user = this.tempProductDefinitionList.find(user => user.name === this.recurringDepositProductDefinitionModel.name);
        if (user != null && user != undefined) {
          if (user.id === this.recurringDepositProductDefinitionModel.id) {
    ...
    if (null != this.tempProductDefinitionList && undefined != this.tempProductDefinitionList && this.tempProductDefinitionList.length > 0) {
      this.tempProductDefinitionList.filter((data: any) => null != data.name).map(product => {
        if (isFlag && product.name === this.recurringDepositProductDefinitionModel.name) {
          this.msgs = [];
