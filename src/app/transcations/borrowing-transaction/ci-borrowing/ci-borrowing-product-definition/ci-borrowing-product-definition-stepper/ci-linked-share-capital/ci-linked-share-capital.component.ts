...
export class CiLinkedShareCapitalComponent {
  ...
  constructor(private formBuilder: FormBuilder,private commonComponent: CommonComponent,private activateRoute: ActivatedRoute,
    ...
    private ciBorrowingProductDefinitionService : CiBorrowingProductDefinitionService, private ciLinkedShareCapitalService :CiLinkedShareCapitalService
  )
  { 
 ...
 /**
   ...
   */
  updateData() {
    this.ciLinkedShareCapitalModel.productId = this.productId
...
/**
   ...
   */
    ...
    this.ciBorrowingProductDefinitionService.getPreviewByProductId(id).subscribe(res => {
      ...
      if (this.responseModel.status == applicationConstants.STATUS_SUCCESS && this.responseModel.data[0] != null) {
        ...
        if (this.ciProductDefinitionModel.ciBorrowingLinkedSharecapitalConfigDTO != null && this.ciProductDefinitionModel.ciBorrowingLinkedSharecapitalConfigDTO != undefined &&
            this.ciProductDefinitionModel.ciBorrowingLinkedSharecapitalConfigDTO.length > 0) {
 ...
 /**
  ...
  saveInlineRow(rowData: any) {
    if(null != this.ciLinkedShareCapitalModel.productId && undefined!=this.ciLinkedShareCapitalModel.productId)
      rowData.productId = this.ciLinkedShareCapitalModel.productId;
    this.addButton = applicationConstants.FALSE;
    this.editDeleteDisable = applicationConstants.FALSE;
