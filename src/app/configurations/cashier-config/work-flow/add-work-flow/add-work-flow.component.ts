  ...
  constructor(private formBuilder: FormBuilder, private datePipe: DatePipe, private router: Router,
    ...
    ngOnInit() {
      this.workFlowColumns = [
        { field: 'commonStatusName', header: 'CASHIERCONFIG.NAME' },
        { field: 'activityName', header: 'CASHIERCONFIG.DESCRIPTION' },
        { field: 'prevStepName', header: 'CASHIERCONFIG.STATUS' },
    ...
    getById(getId: any) {
      ...
      this.workFlowStepService.getById(getId).subscribe((response: any) => {
        ...
        if (this.responseModel.status === applicationConstants.STATUS_SUCCESS) {
          if (this.responseModel != null&& this.responseModel.data!= undefined && this.responseModel.data.length>0 && this.responseModel.data[0] != null && this.responseModel.data[0] != undefined) {
    ...
    backToWorkFlowStep() {
      this.router.navigate([CashierConfigConstants.WORK_FLOW])
    }
