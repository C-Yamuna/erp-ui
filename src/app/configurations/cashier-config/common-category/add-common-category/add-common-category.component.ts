...
export class AddCommonCategoryComponent {
  ...
  disabledButton: boolean = applicationConstants.TRUE;
  addButton: boolean = applicationConstants.TRUE;
  disable: boolean = applicationConstants.TRUE;
  buttonSaveDisabled: boolean = applicationConstants.TRUE;
  buttonDisabled: boolean = applicationConstants.TRUE;
  disabledStatusButton: boolean = applicationConstants.TRUE;
  newRow: any;
  categoryList: any[] = [];
  ...
  //navigation to back
  navigateback() {
    this.router.navigate([CashierConfigConstants.COMMON_CATEGORY]);
  }
