...
private commonCategoryService:CommonCategoryService)
  ...
  addData(){
    this.router.navigate([BorrowingConfigConstants.ADD_COMMON_CATEGORY]);
  }
  ...
  editData(row:any) {
    this.router.navigate([BorrowingConfigConstants.ADD_COMMON_CATEGORY], { queryParams: { id: this.encryptDecryptService.encrypt(row.id) } })
  }
