...
export class DocumentTypesComponent {
  ...
  addkycdoctype() {
    this.router.navigate([SavingsBankConfigConstants.ADD_DOCUMENT_TYPE]);
  }
  getAll() {
  ...
  editkycdoctype(rowData: any) {
    this.router.navigate([SavingsBankConfigConstants.ADD_DOCUMENT_TYPE], { queryParams: { id: this.encryptDecryptService.encrypt(rowData.id) } });
  }
