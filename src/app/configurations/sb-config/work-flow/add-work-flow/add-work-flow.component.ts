  ...
  constructor(private formBuilder: FormBuilder, private datePipe: DatePipe, private router: Router,
    ...
    ngOnInit() {
      this.workFlowColumns = [
        { field: 'commonStatusName', header: 'DEMANDDEPOSITS.NAME' },
        { field: 'activityName', header: 'DEMANDDEPOSITS.DESCRIPTION' },
        { field: 'prevStepName', header: 'DEMANDDEPOSITS.STATUS' },
    ...
    backToWorkFlowStep() {
      this.router.navigate([SavingsBankConfigConstants.WORK_FLOW])
    }
