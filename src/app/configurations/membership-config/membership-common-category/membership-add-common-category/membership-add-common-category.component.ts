...
import { CommonStatus } from '../shared/common-status.model';

@Component({
  selector: 'app-membership-add-common-category',
  templateUrl: './membership-add-common-category.component.html',
  styleUrls: ['./membership-add-common-category.component.css']
})
export class MembershipAddCommonCategoryComponent {
  ...
  addOrUpdate() {
    ...
    if (this.commonCategoryModel != null && this.commonCategoryModel != undefined &&
      this.commonCategoryModel.id != null && this.commonCategoryModel.id != undefined) {
      ...
      this.commonCategoryService.addCommonCategory(this.commonCategoryModel).subscribe((response: any) => {
        ...
        if (this.responseModel.status === applicationConstants.STATUS_SUCCESS) {
          if (this.responseModel.data[0] != null && this.responseModel.data[0] != undefined &&
            this.responseModel.data[0].id != null && this.responseModel.data[0].id != undefined) {
            if (this.responseModel.data[0].id != null && this.responseModel.data[0].id != undefined)
              this.id = this.responseModel.data[0].id;
            this.commonCategoryModel = this.responseModel.data[0];
            if (this.commonCategoryModel.status != null && this.commonCategoryModel.status != undefined && this.commonCategoryModel.status != applicationConstants.ACTIVE) {
  ...
  saveCategoriesStatus(rowData: any) {
    //this.commonComponent.startSpinner();
    rowData.commonCategoryId = this.id;
  ...
  //navigation to back
  navigateback() {
    this.router.navigate([MembershipConfigConstants.COMMON_CATEGORY]);
  }
  ...
  editCommonStatus(row: any) {
    ...
    this.commonStatusModel.commonCategoryId = this.id;
    this.getCommonStatusByCategory(this.id);
    this.btnEditDeleteDisable = true;
    this.btnEditDeleteDisable = true;
    this.addButtonDisabled = true;
