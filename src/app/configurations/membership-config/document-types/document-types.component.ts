...
export class DocumentTypesComponent {
  ...
  constructor(private router: Router, 
    ...
    this.columns = [
      ...
      { field: 'isMandatoryName', header: 'MEMBERSHIPCONFIG.IS_MANDATORY' },
  ...
  addkycdoctype() {
    this.router.navigate([MembershipConfigConstants.ADD_DOCUMENT_TYPE]);
  }
  getAll() {
  ...
  editkycdoctype(rowData: any) {
    this.router.navigate([MembershipConfigConstants.ADD_DOCUMENT_TYPE], { queryParams: { id: this.encryptDecryptService.encrypt(rowData.id) } });
  }
