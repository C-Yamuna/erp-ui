...
export class AddInsurerDetailsComponent {
  ...
  constructor(private router:Router, private formBuilder:FormBuilder,
    ...
    this.insurerdetailsform = this.formBuilder.group({
      ...
      'mobileNo': new FormControl('', [Validators.pattern(applicationConstants.MOBILE_PATTERN),Validators.required]),
      'email': new FormControl('', [Validators.pattern(applicationConstants.EMAIL_PATTERN),Validators.required]),
